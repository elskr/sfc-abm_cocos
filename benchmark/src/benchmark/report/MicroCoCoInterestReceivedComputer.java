 ...
 */
public class MicroCoCoInterestReceivedComputer extends AbstractMicroComputer implements
	...
	public Map<Long, Double> computeVariables(MacroSimulation sim) {
		...
		for (Agent i:pop.getAgents()){
			if(i instanceof Households){
				...
				result.put(household.getAgentId(), household.getCoCoBondInterestReceived());
			}
		}
		return result;
	}
