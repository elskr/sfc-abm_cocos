 ...
 *
 */
public class BanksCoCoBondsComputer extends AbstractMicroComputer implements MicroMultipleVariablesComputer {
	...
	public Map<Long, Double> computeVariables(MacroSimulation sim) {
		...
		for (Agent i:pop.getAgents()){
			...
			if (!agent.isDead()){
			List<Item>loans=agent.getItemsStockMatrix(false, cocobondsId);
			double cocos=0;
			for (Item j:loans){
